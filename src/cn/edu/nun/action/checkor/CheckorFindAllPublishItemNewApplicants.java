...
public class CheckorFindAllPublishItemNewApplicants extends ActionSupport{
	...
	public String execute() throws Exception {
		...
		Page<Applicant> page = this.checkorService.findPublishItemNewApplicantsByPage(this.currentPage);
